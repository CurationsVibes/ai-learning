...
description: Integrate AI into your daily workflows for maximum efficiency and consistency
---
...
- [Advanced Prompting](./01-advanced-prompting/) - Techniques to use in workflows
- [Foundations: Memory](/cookbooks/foundations/03-memory-management/) - Maintain context
- [Tools](/cookbooks/tools/) - MCP and agent integrations
