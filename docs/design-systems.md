...
**The visual language and design philosophy of CURATIONS**

---

## What Is This?

This is CURATIONS' **design system**—the visual identity, brand language, and design principles that guide everything we build.
...
### For CURATIONS Projects

All CURATIONS projects should use this system as a foundation, but:
...
You can:
- **Use it as-is:** Especially if building with CURATIONS
...
"As CURATIONS Design Curator, using the design system principles,
