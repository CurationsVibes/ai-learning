...
**How CURATIONS builds: systems, protocols, and philosophy**

---

## Overview

This is how CURATIONS works technically—the architecture, tools, and principles behind our Human × AI collaboration.
...
**Vector Databases:**
- Embeddings of CURATIONS frameworks, documentation, case studies
...
**Why this matters:**
- AI responses grounded in CURATIONS knowledge
...
"As CURATIONS Technical Curator, design a multi-agent system for [your use case].
